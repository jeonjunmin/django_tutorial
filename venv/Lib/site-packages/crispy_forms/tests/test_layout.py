...
def test_layout_fieldset_row_html_with_unicode_fieldnames(settings):
    ...
    form_helper.add_layout(
        Layout(
            ...
            Fieldset(
                ...
                HTML('<a href="#" id="testLink">python_basic link</a>'),
                HTML(
                    """
    ...
    assert 'python_basic-fieldset="123"' in html
...
def test_second_layout_multifield_column_buttonholder_submit_div():
    ...
    form_helper.add_layout(
        Layout(
            ...
            ButtonHolder(
                Submit(
                    "Save the world", "{{ value_var }}", css_class="button white", data_id="python_basic", data_name="python_basic"
                ),
    ...
    assert 'multifield-python_basic="123"' in html
    assert 'id="column_name"' in html
    assert 'class="formColumn columns"' in html
    assert 'class="buttonHolder">' in html
    assert 'input type="submit"' in html
    assert "button white" in html
    assert 'data-id="python_basic"' in html
    assert 'data-name="python_basic"' in html
    ...
    assert 'id="custom-div"' in html
    assert 'class="customdivs"' in html
    assert 'python_basic-markup="123"' in html
