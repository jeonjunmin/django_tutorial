...
def test_wrap_all_fields():
    ...
    helper.all().wrap(Field, css_class="python_basic-class")
    for field in layout.fields:
        assert isinstance(field, Field)
        assert field.attrs["class"] == "python_basic-class"
...
def test_wrap_selected_fields():
    ...
    helper[1:3].wrap(Field, css_class="python_basic-class")
    ...
    helper[0].wrap(Fieldset, "legend", css_class="python_basic-class")
...
def test_wrap_together_with_slices():
    ...
    layout = Layout("email", "password1", "password2")
    helper.layout = layout
    helper[1:3].wrap_together(Field, css_class="python_basic-class")
    ...
    helper.layout = layout
    helper[0:3].wrap_together(Field, css_class="python_basic-class")
    ...
    layout = Layout("email", "password1", "password2")
    helper.layout = layout
    helper[0].wrap_together(Field, css_class="python_basic-class")
    assert isinstance(layout.fields[0], Field)
    ...
    layout = Layout("email", "password1", "password2")
    helper.layout = layout
    helper[0].wrap_together(Fieldset, "legend", css_class="python_basic-class")
...
def test_wrap_together_partial_slices():
    ...
    helper[:2].wrap_together(Field, css_class="python_basic-class")
    assert isinstance(layout.fields[0], Field)
    ...
    helper[1:].wrap_together(Field, css_class="python_basic-class")
    assert layout.fields[0] == "email"
    assert isinstance(layout.fields[1], Field)
    assert layout.fields[1][0] == "password1"
    assert layout.fields[1][1] == "password2"
...
def test_filter_and_wrap():
    ...
    helper.filter(str).wrap(Field, css_class="python_basic-class")
    assert isinstance(layout.fields[0], Field)
    ...
    helper.filter(Div).wrap(Div, css_class="python_basic-class")
    assert isinstance(layout.fields[1], Div)
...
def test_filter_and_wrap_side_effects():
    ...
    with pytest.raises(DynamicError):
        helper.filter(Div, max_level=2).wrap(Div, css_class="python_basic-class")
